   ...
   //TODO private S3LoggingService s3LoggingService;
    ...
    public void PostFileToS3Bucket(File S3File, String audioBucketName, String audioBucketKey){
        try{
            //Verify file Exists
            if (!S3File.exists()){
              //TODO  s3LoggingService.logMessageToS3("Error: Error on PostFileToS3.java. S3File Does not Exist - PostFileToS3 line 29: " + LocalDate.now() + " On: youtube-service-2" + ",");
            }
         ...
         //TODO   s3LoggingService.logMessageToS3("Error: Error on PostFileToS3.java. Filed To Upload file to S3 - PostFileToS3 line 43: " + LocalDate.now() + " On: youtube-service-2" + ",");
